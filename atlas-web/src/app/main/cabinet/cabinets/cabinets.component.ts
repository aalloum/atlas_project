...
export class CabinetsComponent implements OnInit, OnDestroy {
    ...
    displayedColumns = ['nameCabinet', 'identifiantFiscal', 'activitePrincipale', 'ville'];
    ...
    ngOnInit(): void
    {
        this.dataSource = new FilesDataSource(this.cabinetsService, this.paginator, this.sort);
...
export class FilesDataSource extends DataSource<any>
{
    ...
    )
    {
        ...
        this.filteredData = this.cabinetsService.cabinets;
    }
    ...
    connect(): Observable<any[]>
    {
        const displayDataChanges = [
            this.cabinetsService.onCabinetsChanged,
        ...
        return merge(...displayDataChanges).pipe(map(() => {
                ...
                let data = this.cabinetsService.cabinets.slice();
